    ...
    >
      ...
      >
        ...
        <input
          ...
          required={required}
          className="relative z-10 w-full px-4 pt-6 pb-3 bg-white text-[#111827] placeholder-[#475569] rounded-xl outline-none transition-colors duration-300 text-base"
        />
